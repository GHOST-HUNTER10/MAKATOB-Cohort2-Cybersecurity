...
| 🐧 **Guest** | Cybersecurity Lab VM / Workstation (Ubuntu-based) |
| 📸 **Screenshots** | 26 original screenshots captured during deployment |
...
> Every step below is illustrated with an actual screenshot taken during this deployment.

---

## 2 · Lab Objectives

- 🚀 Deploy the Cybersecurity Lab VM appliance in VirtualBox on a Windows host.
- ⚙️ Configure VM settings: memory, CPU, storage, and network adapter.
- ✅ Verify the VM boots correctly and log in to the desktop environment.
- 🧠 Explore terminal command history and event-designator (`!N`, `!prefix`) behavior.
- 🌐 Verify network connectivity from inside the VM and update installed packages.
- 📝 Answer the lab's review and reflection questions based on hands-on observation.
...
|---|---|---|
| 🔵 Cybersecurity Analyst / Support Technician *(default)* | `cisco` | `password` |
| 🟡 SOC Analyst (CyberOps Associate) | `analyst` | `cyberops` |
| 🔴 Security Engineer (Network Security) | `sec_admin` | `net_secPW` |
...
<img src="./Evidences/25.jpeg" alt="VirtualBox download page" width="70%"/>
...
<img src="./Evidences/1.jpeg" alt="Kali Linux downloads page" width="70%"/>
...
<img src="./Evidences/2.jpeg" alt="Downloading the lab VM appliance" width="70%"/>
...
<img src="./Evidences/3.jpeg" alt="Import Virtual Appliance dialog" width="70%"/>
...
<img src="./Evidences/4.jpeg" alt="Settings General/System" width="70%"/>
...
<img src="./Evidences/5.jpeg" alt="Settings System/Display" width="70%"/>
...
<img src="./Evidences/8.jpeg" alt="Settings Network" width="70%"/>
...
<img src="./Evidences/6.jpeg" alt="VM login screen" width="70%"/>
...
<img src="./Evidences/9.jpeg" alt="Desktop after login" width="70%"/>
...
<img src="./Evidences/12.jpeg" alt="sudo visudo password prompt" width="70%"/>
...
<img src="./Evidences/16.jpeg" alt="nano editing sudoers" width="70%"/>
...
<img src="./Evidences/11.jpeg" alt="grep sudo /etc/group output" width="70%"/>
...
<img src="./Evidences/19.jpeg" alt="history command output" width="70%"/>
...
<img src="./Evidences/23.jpeg" alt="ip a and ping output" width="70%"/> 
...
<img src="./Evidences/24.jpeg" alt="apt install and upgrade" width="70%"/>
...
<img src="./Evidences/26.jpeg" alt="Take Snapshot dialog" width="70%"/>
...
<img src="./Evidences/21.jpeg" alt="!3 history expansion" width="70%"/>
...
<img src="./Evidences/22.jpeg" alt="!his history expansion" width="70%"/>
...
<img src="./Evidences/20.jpeg" alt="hi command not found" width="70%"/>
...
| 🟢 Pre-Built Appliance (.ova) | 🔵 Installer ISO Image |
|---|---|
| • Faster deployment and setup | • Allows full customization during installation |
| • Already configured with required tools and settings | • Greater control over disk layout, packages, and settings |
| • Ideal for labs, training, and beginners | • Can be tailored to specific requirements |
| • Reduces installation and configuration errors | • Provides hands-on experience installing and configuring Linux manually |
